...
Scenario: adding a movie as admin 
  ...
  And  a movie with title “Example Movie” , duration:
  “1:45:23”,  description: “This is a movie about horses” and release date: “10/03/2024” is added to the database. 
